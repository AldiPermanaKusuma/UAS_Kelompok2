...
<head>
    <title>Log in · Neptune</title>
    <link rel="icon" type="image/x-icon" href="images/nep.ico">
                    ...
                    <div class="login-card-img-container row no-gutters">
                        <div class="col-md-6 p-0">
                            <img class="login-card-img"
                                src="https://res.cloudinary.com/dm8y2mzg4/image/upload/v1706945053/momento/posts/sttb_kzmbbj.jpg"
                                alt="">
                        </div>
                        <div class="col-md-6 p-0">
